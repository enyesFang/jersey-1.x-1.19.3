 ...
 * holder.
 */
package com.sun.jersey.test.functional.servlet3.preliminaryapp;
...
public class PreliminaryAppTest extends JerseyTest {
    ...
    public void testDotTxt() {
        ...
        String response = webResource.path("preliminaryapp").path("oneandtwo").path("txt").path("test.txt").get(String.class);
    ...
    public void testDotSlashTxt() {
        WebResource webResource = resource();
        String response = webResource.path("preliminaryapp").path("oneandtwo")
                .path("txt").path("folder").path("test.txt").get(String.class);
